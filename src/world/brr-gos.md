...
Судебная система является двухуровневой. В системе императорских судов рассматриваются наиболее тяжкие или крупные преступления, остальные правонарушения находятся в юрисдикции судебных систем графств, подчиняющихся непосредственно графам. На Барраяре действует прецедентная система права. _Моделирование системы правосудия на Барраяре дано в правилах по [Преступлениям и наказаниям](/rules/crime)._
...
На данный момент Императорская служба безопасности является довольно сложным учреждением с несколькими департаментами, однако на игре мы не моделируем разделение.

Правовое регулирование деятельности СБ на игре описано в отдельных правилах по [Преступлениям и наказаниям](/rules/crime).
...
Правовое регулирование деятельности МПВ на игре описано в отдельных правилах по [Преступлениям и наказаниям](/rules/crime).

...
## Современная Комарра
Во главе Комарры стоит Имперский советник — так здесь именуют вице-короля Комарры. Он обладает всей полнотой исполнительной власти. Кроме того, Имперский советник контролирует систему императорских судов. На данный момент Имперским советником Комарры является лорд Джеральд Форсмит.

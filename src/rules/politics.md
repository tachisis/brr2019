...
Вопросы, поданные на следующую сессию озвучиваются в конце текущей, после чего они публикуются в «Таймс» в специальном разделе «Объединенный совет», который будет сделан к игре.

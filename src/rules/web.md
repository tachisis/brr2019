...
Через мессенджер реализуется модель взлома. Также мессенджер может по желанию использоваться для связи игрок-игрок и игрок-мастер.

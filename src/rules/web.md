...
**Внимание!** Если вы хотите использовать Telegram на игре, вы обязуетесь на время игры выйти из всех развлекательных, новостных и пр. чатов и каналов, в которых идет массовый трафик, и отключить автоматическую загрузку любых типов медиа-файлов. Интернет-канал на игре у нас не очень мощный, и мы будем банить нарушителей сразу. Если телеграм-каналы и чаты нужны вам для вашей работы или иных важных пожизневых случаев, конечно же, вы можете не выходить из них. Также на время игры можно переименовать у себя в записной книжке (откуда их берет телеграм обычно) контакты игроков в персонажные имена, чтобы не было диссонанса.

...
Другие персонажи, у которых есть медикаментозная составляющая, могут произвести медикаментозный допрос (согласно правилам по Инъекциям: подкрасться и сделать инъекцию тайно никак нельзя, но можно персонажу, который [обездвижен](/rules/war/#Обездвиживание) или без сознания) — однако это является преступлением.

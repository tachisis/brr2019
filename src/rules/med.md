...
Сама по себе первая помощь не является лечением, она только позволяет временно предотвратить ухудшение состояния раненого. Оказать первую помощь может любой человек, у которого есть необходимые медикаменты: пластповязка (игрокам необходимо завезти себе бумажный скотч), анальгетик, антибиотик (можно приобрести в Имперском госпитале) по одной дозе. На повязке необходимо написать время оказания первой помощи.
...
И легкое, и тяжелое ухудшение состояния помимо первой помощи требуют обязательного лечения. Лечение тяжелого ранения, криоразморозка производятся только в условиях стационара. Стационаров на игре два: один находится в Имперском госпитале, другой — в посольском квартале.
